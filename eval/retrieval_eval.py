...
# ---------------------------------------------------------------------------
# Golden eval set — imported from single source of truth
# ---------------------------------------------------------------------------
# All 50 questions live in eval/question_bank.py so retrieval_eval.py and
# ragas_eval.py stay in sync automatically when the bank is updated.
